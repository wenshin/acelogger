...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"default\", function() { return SimpleManager; });\n/* harmony import */ var _SimpleLogger__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./SimpleLogger */ \"./src/SimpleLogger.ts\");\n/* harmony import */ var _SimpleTracer__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./SimpleTracer */ \"./src/SimpleTracer.ts\");\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nfunction _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }\n\nfunction _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); return Constructor; }\n\n\n\nvar defaultTimer = {\n  now: function now() {\n    return Date.now();\n  }\n};\n\nvar SimpleManager = /*#__PURE__*/function () {\n  function SimpleManager() {\n    _classCallCheck(this, SimpleManager);\n\n    Object.defineProperty(this, \"registries\", {\n      enumerable: true,\n      writable: true,\n      value: new Map()\n    });\n    this.defaultLogger = new _SimpleLogger__WEBPACK_IMPORTED_MODULE_0__[\"default\"]();\n    this.defaultLogger.manager = this;\n    this.defaultTracer = new _SimpleTracer__WEBPACK_IMPORTED_MODULE_1__[\"default\"]();\n    this.defaultTracer.manager = this;\n  }\n\n  _createClass(SimpleManager, [{\n    key: \"setLogger\",\n    value: function setLogger(logger) {\n      this.registries.set('logger', logger);\n\n      if (logger) {\n        logger.manager = this;\n      }\n    }\n  }, {\n    key: \"setTracer\",\n    value: function setTracer(tracer) {\n      this.registries.set('tracer', tracer);\n\n      if (tracer) {\n        tracer.manager = this;\n      }\n    }\n  }, {\n    key: \"setTimer\",\n    value: function setTimer(timer) {\n      this.registries.set('timer', timer);\n    }\n  }, {\n    key: \"logger\",\n    get: function get() {\n      return this.registries.get('logger') || this.defaultLogger;\n    }\n  }, {\n    key: \"tracer\",\n    get: function get() {\n      return this.registries.get('tracer') || this.defaultTracer;\n    }\n  }, {\n    key: \"timer\",\n    get: function get() {\n      return this.registries.get('timer') || defaultTimer;\n    }\n  }]);\n\n  return SimpleManager;\n}();\n\n\n\n//# sourceURL=webpack:///./src/SimpleManager.ts?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _SimpleLogger__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./SimpleLogger */ \"./src/SimpleLogger.ts\");\n/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, \"SimpleLogger\", function() { return _SimpleLogger__WEBPACK_IMPORTED_MODULE_0__[\"default\"]; });\n\n/* harmony import */ var _SimpleTracer__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./SimpleTracer */ \"./src/SimpleTracer.ts\");\n/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, \"createTraceId\", function() { return _SimpleTracer__WEBPACK_IMPORTED_MODULE_1__[\"createTraceId\"]; });\n\n/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, \"SimpleTracer\", function() { return _SimpleTracer__WEBPACK_IMPORTED_MODULE_1__[\"default\"]; });\n\n/* harmony import */ var _SimpleManager__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./SimpleManager */ \"./src/SimpleManager.ts\");\n/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, \"SimpleManager\", function() { return _SimpleManager__WEBPACK_IMPORTED_MODULE_2__[\"default\"]; });\n\n/* harmony import */ var _exporters_ConsoleExporterWeb__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./exporters/ConsoleExporterWeb */ \"./src/exporters/ConsoleExporterWeb.ts\");\n/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, \"ConsoleExporterWeb\", function() { return _exporters_ConsoleExporterWeb__WEBPACK_IMPORTED_MODULE_3__[\"default\"]; });\n\n/* harmony import */ var _exporters_ConsoleExporterNode__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./exporters/ConsoleExporterNode */ \"./src/exporters/ConsoleExporterNode.ts\");\n/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, \"ConsoleExporterNode\", function() { return _exporters_ConsoleExporterNode__WEBPACK_IMPORTED_MODULE_4__[\"default\"]; });\n\n/* harmony import */ var _api__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./api */ \"./src/api/index.ts\");\n/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _api__WEBPACK_IMPORTED_MODULE_5__) if([\"default\",\"createTraceId\",\"ConsoleExporterWeb\",\"ConsoleExporterNode\",\"SimpleLogger\",\"SimpleTracer\",\"SimpleManager\"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _api__WEBPACK_IMPORTED_MODULE_5__[key]; }) }(__WEBPACK_IMPORT_KEY__));\n/* harmony import */ var _consts__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./consts */ \"./src/consts/index.ts\");\n/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, \"TAG_USER_ID\", function() { return _consts__WEBPACK_IMPORTED_MODULE_6__[\"TAG_USER_ID\"]; });\n\n/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, \"TAG_USER_NAME\", function() { return _consts__WEBPACK_IMPORTED_MODULE_6__[\"TAG_USER_NAME\"]; });\n\n/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, \"TAG_USER_OS_NAME\", function() { return _consts__WEBPACK_IMPORTED_MODULE_6__[\"TAG_USER_OS_NAME\"]; });\n\n/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, \"TAG_USER_OS_VERSION\", function() { return _consts__WEBPACK_IMPORTED_MODULE_6__[\"TAG_USER_OS_VERSION\"]; });\n\n/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, \"TAG_USER_PLATFORM_NAME\", function() { return _consts__WEBPACK_IMPORTED_MODULE_6__[\"TAG_USER_PLATFORM_NAME\"]; });\n\n/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, \"TAG_USER_PLATFORM_VERSION\", function() { return _consts__WEBPACK_IMPORTED_MODULE_6__[\"TAG_USER_PLATFORM_VERSION\"]; });\n\n/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, \"TAG_USER_DEVICE\", function() { return _consts__WEBPACK_IMPORTED_MODULE_6__[\"TAG_USER_DEVICE\"]; });\n\n/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, \"TAG_USER_LOCALE\", function() { return _consts__WEBPACK_IMPORTED_MODULE_6__[\"TAG_USER_LOCALE\"]; });\n\n/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, \"TAG_USER_CITY\", function() { return _consts__WEBPACK_IMPORTED_MODULE_6__[\"TAG_USER_CITY\"]; });\n\n/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, \"TAG_USER_COUNTRY\", function() { return _consts__WEBPACK_IMPORTED_MODULE_6__[\"TAG_USER_COUNTRY\"]; });\n\n/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, \"TAG_USER_SCREEN_DPR\", function() { return _consts__WEBPACK_IMPORTED_MODULE_6__[\"TAG_USER_SCREEN_DPR\"]; });\n\n/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, \"TAG_USER_SCREEN_RESOLUTION\", function() { return _consts__WEBPACK_IMPORTED_MODULE_6__[\"TAG_USER_SCREEN_RESOLUTION\"]; });\n\n/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, \"TAG_USER_NET_TYPE\", function() { return _consts__WEBPACK_IMPORTED_MODULE_6__[\"TAG_USER_NET_TYPE\"]; });\n\n/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, \"TAG_USER_NET_VENDOR\", function() { return _consts__WEBPACK_IMPORTED_MODULE_6__[\"TAG_USER_NET_VENDOR\"]; });\n\n/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, \"TAG_IDC\", function() { return _consts__WEBPACK_IMPORTED_MODULE_6__[\"TAG_IDC\"]; });\n\n/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./utils */ \"./src/utils.ts\");\n/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, \"isTimeInputHrTime\", function() { return _utils__WEBPACK_IMPORTED_MODULE_7__[\"isTimeInputHrTime\"]; });\n\n/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, \"getMillisecondsTime\", function() { return _utils__WEBPACK_IMPORTED_MODULE_7__[\"getMillisecondsTime\"]; });\n\n/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, \"isCountEvent\", function() { return _utils__WEBPACK_IMPORTED_MODULE_7__[\"isCountEvent\"]; });\n\n/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, \"getLogLevelByStatus\", function() { return _utils__WEBPACK_IMPORTED_MODULE_7__[\"getLogLevelByStatus\"]; });\n\n\n\n\n\n\n\n\n\n\nvar manager = new _SimpleManager__WEBPACK_IMPORTED_MODULE_2__[\"default\"]();\n/* harmony default export */ __webpack_exports__[\"default\"] = (manager);\n\n//# sourceURL=webpack:///./src/index.ts?");
...
/*!**********************!*\
  !*** ./src/utils.ts ***!
  \**********************/
/*! exports provided: isTimeInputHrTime, getMillisecondsTime, isCountEvent, getLogLevelByStatus */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"isTimeInputHrTime\", function() { return isTimeInputHrTime; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"getMillisecondsTime\", function() { return getMillisecondsTime; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"isCountEvent\", function() { return isCountEvent; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"getLogLevelByStatus\", function() { return getLogLevelByStatus; });\n/* harmony import */ var _api__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./api */ \"./src/api/index.ts\");\n\nfunction isTimeInputHrTime(time) {\n  return Array.isArray(time) && time.length === 2;\n}\nfunction getMillisecondsTime(time) {\n  return time && isTimeInputHrTime(time) ? time[0] * 1e3 + time[1] / 1e6 : time;\n}\nfunction isCountEvent(evt) {\n  return evt && (evt.type === _api__WEBPACK_IMPORTED_MODULE_0__[\"EventType\"].Tracing || evt.type === _api__WEBPACK_IMPORTED_MODULE_0__[\"EventType\"].Event);\n}\nfunction getLogLevelByStatus(status) {\n  switch (status) {\n    case _api__WEBPACK_IMPORTED_MODULE_0__[\"CanonicalCode\"].OK:\n      // success status use debug level\n      return _api__WEBPACK_IMPORTED_MODULE_0__[\"LogLevel\"].Debug;\n\n    case _api__WEBPACK_IMPORTED_MODULE_0__[\"CanonicalCode\"].INTERNAL:\n    case _api__WEBPACK_IMPORTED_MODULE_0__[\"CanonicalCode\"].RESOURCE_EXHAUSTED:\n    case _api__WEBPACK_IMPORTED_MODULE_0__[\"CanonicalCode\"].UNAVAILABLE:\n      return _api__WEBPACK_IMPORTED_MODULE_0__[\"LogLevel\"].Error;\n\n    default:\n      return _api__WEBPACK_IMPORTED_MODULE_0__[\"LogLevel\"].Warn;\n  }\n}\n\n//# sourceURL=webpack:///./src/utils.ts?");
